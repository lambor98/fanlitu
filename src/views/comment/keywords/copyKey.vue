    ...
    <div class="copywuxin sonBox">
        <ul>
            <li>
                ...
                <p class="tip">您的好评内容中必须包含如下关键词：<span class="red">面料舒适</span></p>
...
export default {
    ...
    methods:{
        ...
        submit(){
            if(this.imgName){
                axios.post(this.url+"/comment/submitCopyKeyEval",{order_id:this.info.order_id,have_evaluation:this.imgName}).then(res=>{
                    if(res.data.status=="1000"){
                        Toast.success("提交成功")
